...
namespace MyNesSDL
{
    [RoomBaseAttributes("Input Settings - Player Four")]
    public class Room_Input_PlayerFour:RoomBase
    {
        public Room_Input_PlayerFour()
            : base()
        {
        ...
        {
            public MenuItem_ApplyAndBack(Room_Input_PlayerFour page)
            {
                this.page = page;
            }

            Room_Input_PlayerFour page;

            public override void Execute()
            {
                if (page.Items[0].Options.Count == 1)
                    Settings.Key_P4_UseJoystick = false;
                else
                    Settings.Key_P4_UseJoystick = page.Items[0].SelectedOptionIndex == 1;
                Settings.Key_P4_JoystickIndex = page.Items[1].SelectedOptionIndex;
                if (!Settings.Key_P4_UseJoystick)
                {
                    Settings.Key_P4_ButtonA = page.Items[2].Options[0];
                    Settings.Key_P4_ButtonB = page.Items[3].Options[0];
                    Settings.Key_P4_ButtonTurboA = page.Items[4].Options[0];
                    Settings.Key_P4_ButtonTurboB = page.Items[5].Options[0];
                    Settings.Key_P4_ButtonStart = page.Items[6].Options[0];
                    Settings.Key_P4_ButtonSelect = page.Items[7].Options[0];
                    Settings.Key_P4_ButtonUp = page.Items[8].Options[0];
                    Settings.Key_P4_ButtonDown = page.Items[9].Options[0];
                    Settings.Key_P4_ButtonLeft = page.Items[10].Options[0];
                    Settings.Key_P4_ButtonRight = page.Items[11].Options[0];
                }
                else
                {
                    Settings.JoyKey_P4_ButtonA = page.Items[2].Options[0];
                    Settings.JoyKey_P4_ButtonB = page.Items[3].Options[0];
                    Settings.JoyKey_P4_ButtonTurboA = page.Items[4].Options[0];
                    Settings.JoyKey_P4_ButtonTurboB = page.Items[5].Options[0];
                    Settings.JoyKey_P4_ButtonStart = page.Items[6].Options[0];
                    Settings.JoyKey_P4_ButtonSelect = page.Items[7].Options[0];
                    Settings.JoyKey_P4_ButtonUp = page.Items[8].Options[0];
                    Settings.JoyKey_P4_ButtonDown = page.Items[9].Options[0];
                    Settings.JoyKey_P4_ButtonLeft = page.Items[10].Options[0];
                    Settings.JoyKey_P4_ButtonRight = page.Items[11].Options[0];
                }
        ...
        {
            public MenuItem_ResetDefaults(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_A(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_B(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_TurboA(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_TurboB(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Start(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Select(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Up(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Down(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Left(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Right(Room_Input_PlayerFour page)
            {
                this.page = page;
            }
