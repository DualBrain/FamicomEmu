...
namespace MyNesSDL
{
    [RoomBaseAttributes("Input Settings - Player Three")]
    public class Room_Input_PlayerThree:RoomBase
    {
        public Room_Input_PlayerThree()
            : base()
        {
            ...
            if (SelectedMenuIndex == 0)
            {
                if (Items[0].Options[0] != "N/A")
                {
                    if (Items[0].SelectedOptionIndex == 0)// NO
                    {
                        ...
                        Items[2].Options.Add(Settings.Key_P3_ButtonA);
                        Items[3].Options.Clear();
                        Items[3].Options.Add(Settings.Key_P3_ButtonB);
                        Items[4].Options.Clear();
                        Items[4].Options.Add(Settings.Key_P3_ButtonTurboA);
                        Items[5].Options.Clear();
                        Items[5].Options.Add(Settings.Key_P3_ButtonTurboB);
                        Items[6].Options.Clear();
                        Items[6].Options.Add(Settings.Key_P3_ButtonStart);
                        Items[7].Options.Clear();
                        Items[7].Options.Add(Settings.Key_P3_ButtonSelect);
                        Items[8].Options.Clear();
                        Items[8].Options.Add(Settings.Key_P3_ButtonUp);
                        Items[9].Options.Clear();
                        Items[9].Options.Add(Settings.Key_P3_ButtonDown);
                        Items[10].Options.Clear();
                        Items[10].Options.Add(Settings.Key_P3_ButtonLeft);
                        Items[11].Options.Clear();
                        Items[11].Options.Add(Settings.Key_P3_ButtonRight);
                    }
                    else
                    {
                        useJoystick = true;
                        Items[2].Options.Clear();
                        Items[2].Options.Add(Settings.JoyKey_P3_ButtonA);
                        Items[3].Options.Clear();
                        Items[3].Options.Add(Settings.JoyKey_P3_ButtonB);
                        Items[4].Options.Clear();
                        Items[4].Options.Add(Settings.JoyKey_P3_ButtonTurboA);
                        Items[5].Options.Clear();
                        Items[5].Options.Add(Settings.JoyKey_P3_ButtonTurboB);
                        Items[6].Options.Clear();
                        Items[6].Options.Add(Settings.JoyKey_P3_ButtonStart);
                        Items[7].Options.Clear();
                        Items[7].Options.Add(Settings.JoyKey_P3_ButtonSelect);
                        Items[8].Options.Clear();
                        Items[8].Options.Add(Settings.JoyKey_P3_ButtonUp);
                        Items[9].Options.Clear();
                        Items[9].Options.Add(Settings.JoyKey_P3_ButtonDown);
                        Items[10].Options.Clear();
                        Items[10].Options.Add(Settings.JoyKey_P3_ButtonLeft);
                        Items[11].Options.Clear();
                        Items[11].Options.Add(Settings.JoyKey_P3_ButtonRight);
                    }
                }
            }
        ...
        public override void OnOpen()
        {
            ...
            if (Joysticks.NumberOfJoysticks > 0)
            {
                ...
                Items[0].SelectedOptionIndex = Settings.Key_P3_UseJoystick ? 1 : 0;
                useJoystick = Settings.Key_P3_UseJoystick;
                Items[1].Options.Clear();
                if (Settings.Key_P3_JoystickIndex < Joysticks.NumberOfJoysticks)
                {
                    for (int i = 0; i < Joysticks.NumberOfJoysticks; i++)
                    {
                        Items[1].Options.Add(i.ToString());
                    }
                    Items[1].SelectedOptionIndex = Settings.Key_P3_JoystickIndex;
                }
                else
                {
            ...
            if (!(joyKeys && Settings.Key_P3_UseJoystick))
            {
                Items[2].Options.Clear();
                Items[2].Options.Add(Settings.Key_P3_ButtonA);
                Items[3].Options.Clear();
        ...
        {
            public MenuItem_ApplyAndBack(Room_Input_PlayerThree page)
            {
                this.page = page;
            }

            Room_Input_PlayerThree page;

            public override void Execute()
            {
                if (page.Items[0].Options.Count == 1)
                    Settings.Key_P3_UseJoystick = false;
                else
                    Settings.Key_P3_UseJoystick = page.Items[0].SelectedOptionIndex == 1;
                Settings.Key_P3_JoystickIndex = page.Items[1].SelectedOptionIndex;
                if (!Settings.Key_P3_UseJoystick)
                {
                    Settings.Key_P3_ButtonA = page.Items[2].Options[0];
                    Settings.Key_P3_ButtonB = page.Items[3].Options[0];
                    Settings.Key_P3_ButtonTurboA = page.Items[4].Options[0];
                    Settings.Key_P3_ButtonTurboB = page.Items[5].Options[0];
                    Settings.Key_P3_ButtonStart = page.Items[6].Options[0];
                    Settings.Key_P3_ButtonSelect = page.Items[7].Options[0];
                    Settings.Key_P3_ButtonUp = page.Items[8].Options[0];
                    Settings.Key_P3_ButtonDown = page.Items[9].Options[0];
                    Settings.Key_P3_ButtonLeft = page.Items[10].Options[0];
                    Settings.Key_P3_ButtonRight = page.Items[11].Options[0];
                }
                else
                {
                    Settings.JoyKey_P3_ButtonA = page.Items[2].Options[0];
                    Settings.JoyKey_P3_ButtonB = page.Items[3].Options[0];
                    Settings.JoyKey_P3_ButtonTurboA = page.Items[4].Options[0];
                    Settings.JoyKey_P3_ButtonTurboB = page.Items[5].Options[0];
                    Settings.JoyKey_P3_ButtonStart = page.Items[6].Options[0];
                    Settings.JoyKey_P3_ButtonSelect = page.Items[7].Options[0];
                    Settings.JoyKey_P3_ButtonUp = page.Items[8].Options[0];
                    Settings.JoyKey_P3_ButtonDown = page.Items[9].Options[0];
                    Settings.JoyKey_P3_ButtonLeft = page.Items[10].Options[0];
                    Settings.JoyKey_P3_ButtonRight = page.Items[11].Options[0];
                }
        ...
        {
            public MenuItem_ResetDefaults(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
            ...
            public override void Execute()
            {
                ...
                page.Items[2].Options.Add("");
                page.Items[3].Options.Clear();
                page.Items[3].Options.Add("");
                page.Items[4].Options.Clear();
                page.Items[4].Options.Add("");
                page.Items[5].Options.Clear();
                page.Items[5].Options.Add("");
                page.Items[6].Options.Clear();
                page.Items[6].Options.Add("");
                page.Items[7].Options.Clear();
                page.Items[7].Options.Add("");
                page.Items[8].Options.Clear();
                page.Items[8].Options.Add("");
                page.Items[9].Options.Clear();
                page.Items[9].Options.Add("");
                page.Items[10].Options.Clear();
                page.Items[10].Options.Add("");
                page.Items[11].Options.Clear();
                page.Items[11].Options.Add("");
            }
        }
        ...
        {
            public MenuItem_A(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_B(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_TurboA(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_TurboB(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Start(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Select(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Up(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Down(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Left(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
        ...
        {
            public MenuItem_Right(Room_Input_PlayerThree page)
            {
                this.page = page;
            }
